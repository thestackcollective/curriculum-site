...
- Recreate the IdeaBox from last inning by following [this guide](https://curriculum.thestackcollective.org/module3/lessons/react_ideabox). This guide is for building an ideabox using React and JavaScript, not TypeScript.  As you go, let the TypeScript errors guide you to make the necessary adjustments to your code.
