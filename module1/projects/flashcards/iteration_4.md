...
```
What is 5 + 5?,10,STEM
What is Rachel's favorite animal?,red panda,TheStackCollective Staff
What is Mike's middle name?,nobody knows,TheStackCollective Staff
What cardboard cutout lives at TheStackCollective?,Justin bieber,PopCulture
```
...
#=> [#<Card:0x007f9f1413cbe8 @answer="10", @question="What is 5 + 5?", @category="STEM">,
 #<Card:0x007f9f1413c788 @answer="red panda", @question="What is Rachel's favorite animal?", @category="TheStackCollective Staff">,
 #<Card:0x007f9f1413c2b0 @answer="nobody knows", @question="What is Mike's middle name?", @category="TheStackCollective Staff">,
 #<Card:0x007f9f14137da0 @answer="Justin bieber", @question="What cardboard cutout lives at TheStackCollective?", @category="Pop Culture">]
```
